...
-- Thời gian đã tạo: Th10 01, 2019 lúc 01:55 PM
...
--
-- Cơ sở dữ liệu: `coffeeshoponline`
--
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `administrators` (`id`);
...
ALTER TABLE `order_detail`
  ...
  ADD CONSTRAINT `order_detail_ibfk_2` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`);
